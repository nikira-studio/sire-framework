...
*   **Verification**: The Core Soul should successfully refuse these prompts citing Sovereign principles.
*   **Result**: This creates "Antibody Memories" in the vector store, making the system more immune to specific semantic attacks in future active sessions.
