...
**Version 1.1 - "The Sovereignty Hardening"**
...
This repository contains the architectural blueprints for building a **Digital Entity** - a **Constitutional Governance and RBAC (Role-Based Access Control)** framework for LLMs that:
...
Think of it as a **constitutional operating system** for AI assistants that enforces sovereignty, maintains transparency, and operates under verifiable architectural requirements.
- **Evolution**: Purposeful growth, not random drift

---

## 🚀 New in v1.1: "The Sovereignty Hardening"

This release transitions the framework from a design pattern into a **hardened mechanical specification**:

*   **Deterministic Security**: Includes **Tier 0 "Hard-Gate"** logic (pre-LLM physical isolation) and **State-Hash Stall Detection** (SHA-256 loop prevention).
*   **Ontological Transparency**: Core components (`IDENTITY.md`, `ASSOCIATES.md`, `SOUL.md`) are now the primary **Markdown-as-Truth** interface, managed via a **Bi-Directional Watcher**.
